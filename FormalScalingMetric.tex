...
\begin{figure}
  \centering
  \includegraphics[width=.5\linewidth]{images/OldfieldTimeLog}
...
\begin{figure}
  \includegraphics[width=.5\linewidth]{images/OldfieldRate}%
  \includegraphics[width=.5\linewidth]{images/OldfieldEfficiency}
